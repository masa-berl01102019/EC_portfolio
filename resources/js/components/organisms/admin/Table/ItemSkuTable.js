...
const ItemSkuTable = memo(({ skus, colors, sizes, className = '', deleteMethod, handleFormMethod }) => {
            ...
            <Row key={index}>
              ...
              <Td>
                <Selectbox
                  name='size_id'
                  value={list.size_id}
                  onChange={e => handleFormMethod('skus', index, e)}
              ...
              <Td>
                <InputText
                  type='number'
                  name='quantity'
                  onBlur={e => handleFormMethod('skus', index, e)}
                  value={list.quantity}
                  placeholder='12'
                  className={styles.table_row_form}
                />
