...
function ItemEdit(props) {
    ...
    const handleFormSendwithFile = () => {
        ...
        dispatch({type: 'CREATE', form: params, url: `/api/admin/items/${props.match.params.id}`, headers: {'content-type': 'multipart/form-data'} });
    } // URL違う / formオブジェクトはnullを文字列にしてしまうのでその部分を修正
