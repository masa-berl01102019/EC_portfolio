                        ...
                        <div className={styles.form_area}>
                            <form onSubmit={ e => {
                                ...
                                <div className={[styles.flex, styles.flex_sp].join(' ')}>
                                    <div className={[styles.mr_24, styles.mb_16].join(' ')}>
                                        <div className={styles.mb_10}>
                                            <label htmlFor='delivery_date'><Text>配達希望日</Text></label>
                                        </div>
                                        <div>
                                            <DatePicker 
                                                name={'delivery_date'} 
                                            ...
                                            />
                                            { errorMessage && <Text role='error' size='s'>{errorMessage.delivery_date}</Text> }
                                        </div>
                                    </div>
                                    <div className={[styles.flex_grow, styles.mb_16].join(' ')}>
                                        <FormSelectbox
                                            name='delivery_time'
                                ...
                                <div className={[styles.flex, styles.align_center, styles.justify_center].join(' ')}>
                                    <LinkBtn to={`/admin/orders`} size='l' className={[styles.mr_12, styles.w_100].join(' ')}>一覧に戻る</LinkBtn>
